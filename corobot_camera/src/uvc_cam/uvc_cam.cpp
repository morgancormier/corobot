  ...
  width(_width), height(_height), fps(_fps), rgb_frame(NULL)
{
  ...
  try
  {
	...
	set_control(V4L2_CID_EXPOSURE_AUTO, 3);
    set_control(0x009a0903, 1);
  ...
  //  set_control(V4L2_CID_EXPOSURE_ABSOLUTE_NEW, 300);
    ...
    set_control(V4L2_CID_AUTO_WHITE_BALANCE, 1);
    set_control(V4L2_CID_GAIN, 120);
    set_control(V4L2_CID_SHARPNESS, 140);
    set_control(V4L2_CID_SATURATION, 45);
